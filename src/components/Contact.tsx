...
export default function Contact() {
  ...
  const socialLinks = [
    { name: 'GitHub', icon: "icons/github.svg", url: 'https://github.com/Sudhanva1999', text: 'GitHub' },
    { name: 'Instagram', icon: "icons/instagram.svg", url: 'https://instagram.com/Sudhanva1999', text: 'Instagram' },
    { name: 'LinkedIn', icon: "icons/linkedin.svg", url: 'https://linkedin.com/in/sudhanvapaturkar', text: 'LinkedIn' },
